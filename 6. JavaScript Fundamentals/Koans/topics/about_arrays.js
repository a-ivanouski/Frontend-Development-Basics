...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(0, 1);
    ok(workingWeek.equalTo(['Monday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
